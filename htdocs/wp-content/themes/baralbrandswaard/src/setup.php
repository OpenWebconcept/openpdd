...
add_action('after_setup_theme', function () {
    load_theme_textdomain('baralbrandswaard', get_stylesheet_directory() . '/languages/');
    ...
    $sidebars = [
        [
            'name'        => __('Footer column 1', 'baralbrandswaard'),
            'id'          => 'footer-1',
            'description' => '',
            'class'       => '',
        ],
        [
            'name'        => __('Footer column 2', 'baralbrandswaard'),
            'id'          => 'footer-2',
            'description' => '',
            'class'       => '',
        ],
        [
            'name'        => __('Footer column 3', 'baralbrandswaard'),
            'id'          => 'footer-3',
            'description' => '',
            'class'       => '',
        ],
