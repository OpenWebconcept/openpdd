    ...
    <div class="dropdown">
        ...
        <div class="shadow dropdown-menu dropdown-menu-right" aria-hidden="true">
            <div class="dropdown-item d-flex justify-content-between align-items-center font-weight-bold text-dark text-decoration-none mb-2" href="<?php echo home_url('/overzicht'); ?>">
                <?php _e('Overzicht', 'yard-startertheme'); ?>
                <button class="dropdown-button-close" aria-label="<?php _e('Sluiten', 'yard-startertheme'); ?>">
            ...
            <a class="dropdown-item d-flex justify-content-between align-items-center <?php echo is_page('mijn-gegevens') ? 'active' : ''; ?>" href="<?php echo home_url('/mijn-gegevens'); ?>">
                <?php _e('Mijn gegevens', 'yard-startertheme'); ?>
            ...
            <a class="dropdown-item d-flex justify-content-between align-items-center" href="<?php echo home_url('digid/logout') ?>">
                <?php _e('Uitloggen', 'yard-startertheme'); ?>
...
<?php else : ?>
    <a href="<?php echo home_url(); ?>" class="btn btn-primary white-space-nowrap">
        ...
        <?php _e('Inloggen', 'yard-startertheme'); ?>
    </a>
<?php endif; ?>
