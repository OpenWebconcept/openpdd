...
class GWPreviewConfirmation
{
    ...
    {
        add_filter('gform_pre_render', [ __class__, 'replace_merge_tags' ]);
    }
    ...
    */
    ...
    public static function preview_replace_variables($content, $form)
    {
        ...
        add_filter('gform_merge_tag_filter', ['GWPreviewConfirmation', 'preview_special_merge_tags'], 10, 4);
        ...
        remove_filter('gform_merge_tag_filter', ['GWPreviewConfirmation', 'preview_special_merge_tags']);
    ...
    public static function clear_field_value_cache($form)
    {
        ...
        foreach ($form['fields'] as &$field) {
            if ('total' == GFFormsModel::get_input_type($field)) {
